...
- [Автоматическое развертывание студенческих проектов на Django](#автоматическое-развертывание-студенческих-проектов-на-django)
  ...
  - [Настройка базы данных PostgreSQL](#настройка-базы-данных-postgresql)
    - [1. Создание файла .env](#1-создание-файла-env)
    - [2. Инициализация базы данных](#2-инициализация-базы-данных)
    - [3. Миграция данных из SQLite (если есть)](#3-миграция-данных-из-sqlite-если-есть)
    - [4. Выполнение миграций Django](#4-выполнение-миграций-django)
